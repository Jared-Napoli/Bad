...
class SearchQueriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search_query" do
    assert_difference('SearchQuery.count') do
      post search_queries_url, params: { search_query: { query_response: @search_query.query_response, query_string: @search_query.query_string } }
    end
  ...
  test "should update search_query" do
    patch search_query_url(@search_query), params: { search_query: { query_response: @search_query.query_response, query_string: @search_query.query_string } }
